...
Stonktop is designed to be accessible to all users, including those with disabilities. Key accessibility features include:

- **Keyboard-only navigation** - No mouse required; all features accessible via keyboard
- **High contrast colors** - WCAG AA compliant color contrast ratios
- **Clear labeling** - Column headers and help text explain all information
- **Non-color dependent** - Information conveyed through text and numbers, not color alone
- **Configurable refresh rates** - Adjust display speed with `--delay` option
- **Vim-style keybindings** - Optional hjkl navigation for compatibility with assistive tech

For detailed accessibility information, including recommendations for users with specific disabilities and future enhancements, see [ACCESSIBILITY.md](ACCESSIBILITY.md).
